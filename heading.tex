...
\begin{figure}[hbtp]
\centering
\includegraphics[width=3.34in]{images/closedCapsule.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=3.34in]{images/hollowCapsule.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=3.34in]{images/openCapsule.png}
...
\section*{Appendix A: Sample Source Code} \label{app:Github}
\subsection*{Github}
