...
\entry{$\epsilon$}{Emissivity Factor}
\entry{$\gamma$}{Heat Capacity Ratio}
\entry{$\rho$}{Total, Hemispherical Reflectivity}
...
\entry{c1MN}{Mach number,front face of the first compressor}
...
\entry{NTU}{Number of Transfer Units}
...
\entry{T}{Temperature}
\entry{${\eta}_{ad}$}{Adiabatic Efficiency}
\end{nomenclature}
